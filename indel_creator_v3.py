...
def main():
    ...
    # Read user data from the user file
    user_data, iq_model = read_user_data(user_file_path)
    ...
    # Validate user data against the JSON template
    validate_user_data(user_data, json_data)
    
    # Generate 600 simulation files with different out_file names
    indelible_input_path = 'path/to/indelible_input'
    ...
    # Rename input files for INDELIBLE
    rename_indel(indelible_input_path)
    
    # Move output files generated by INDELIBLE
    indelible_output_path = 'path/to/indelible_output'
    move_to_indel_output(indelible_input_path, indelible_output_path)
    
    # Rename sequence identifiers and run IQ-TREE
    IQTREE_path = 'path/to/iqtree_output'
    IQTREE_exe_path = 'path/to/iqtree_executable'
    rename_seq_fasta(indelible_output_path, IQTREE_path, IQTREE_exe_path, iq_model)
    
    # Move tree files generated by IQ-TREE
    tree_output_path = 'path/to/tree_output'
    move_tree_files(IQTREE_path, tree_output_path)
    
    # Graph correct outputs
    tq_dist_path = 'path/to/tqDist_executable'
...
def move_to_indel_output(indel_input_path, output_directory):
    """Move output files generated by INDELIBLE to the specified output directory."""
    pass
...
def move_tree_files(iqtree_output_path, tree_output_path):
    """Move tree files generated by IQ-TREE to the specified tree_output directory."""
    pass
