...
def move_to_indel_output(GTR_path, output_directory):
    ...
    for f in os.listdir(GTR_path):
        if f.startswith('GTR'):
            src_path = os.path.join(GTR_path, f)
...
GTR_path  = f'/home/s36jshem_hpc/sealion/runs/'
move_to_indel_output(GTR_path, indelible_output_path)
